...
public class DocxRenderer implements IRender {
    ...
    final public static DataKey<String> FOOTNOTE_TEXT = new DataKey<>("FOOTNOTE_TEXT", "afb");
    ...
    final public static DataKey<String> HYPERLINK_STYLE = new DataKey<>("HYPERLINK_STYLE", "a6");
    ...
    final public static DataKey<String> LOOSE_PARAGRAPH_STYLE = new DataKey<>("LOOSE_PARAGRAPH_STYLE", "C503-2");
    ...
    final public static DataKey<String> TIGHT_PARAGRAPH_STYLE = new DataKey<>("TIGHT_PARAGRAPH_STYLE", "C503-2");

    final public static DataKey<String> WLS_PARAGRAPH_STYLE = new DataKey<>("WLS_PARAGRAPH_STYLE", "C503-2");

    final public static DataKey<String> DEFAULT_TEMPLATE_RESOURCE = new DataKey<>("WLS_PARAGRAPH_STYLE", "/empty.xml");
